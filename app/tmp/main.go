...
import (
	...
	_ "addressBook/app"
	controllers "addressBook/app/controllers"
	tests "addressBook/tests"
...
func main() {
	...
	revel.RegisterController((*controllers.Register)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Add",
	...
	revel.RegisterController((*controllers.Contact)(nil),
		[]*revel.MethodType{
			&revel.MethodType{
				Name: "Save",
				Args: []*revel.MethodArg{ 
	...
	testing.TestSuites = []interface{}{ 
		(*tests.AppTest)(nil),
		(*tests.ContactTest)(nil),
		(*tests.LoginTest)(nil),
		(*tests.RegisterTest)(nil),
	}
